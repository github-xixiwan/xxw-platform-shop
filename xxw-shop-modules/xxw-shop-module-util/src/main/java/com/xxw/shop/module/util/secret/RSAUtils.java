package com.xxw.shop.module.util.secret;

import com.xxw.shop.module.util.exception.UtilException;
...
public class RSAUtils {
    ...
    public static Map<String, String> generateRasKey() {
        ...
        try {
            ...
            throw new UtilException("RsaUtils invoke genKeyPair failed.");
        }
        return rs;
    }
    ...
    public static String encrypt(String str, String publicKey) {
        try {
            ...
            throw new UtilException("RsaUtils invoke encrypt failed.");
        }
    }
    ...
    public static String decrypt(String str, String privateKey) {
        ...
        try {
            ...
            throw new UtilException("RsaUtils invoke decrypt failed.");
        }
